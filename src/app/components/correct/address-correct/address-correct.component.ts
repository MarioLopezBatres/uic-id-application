...
@Component({
  selector: "app-address-correct",
  templateUrl: "./address-correct.component.html",
  styleUrls: ["./address-correct.component.css"]
})
export class AddressCorrectComponent implements OnInit {
  ...
  onNavigate(direction) {
    ...
    this.values.validateFormCorrect(direction, forms, 4);
  }
